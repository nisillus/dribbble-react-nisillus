...
const fetchProductsByCate = (cate_code) => cate_code ? database.ref('/products/').orderByChild('cate_code').equalTo(cate_code).once('value') : database.ref('/products').once('value');
