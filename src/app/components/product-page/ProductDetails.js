  ...
  <div className="Product-details">
    <div className="col-md-9 rsrc-main">
      <div className="woocommerce">
        ...
        <div id="product-707" className="post-707 product type-product status-publish has-post-thumbnail product_cat-jewelry first instock sale shipping-taxable purchasable product-type-simple">
          ...
          <div className="woocommerce-product-gallery woocommerce-product-gallery--with-images woocommerce-product-gallery--columns-4 images" data-columns="4" style={ { opacity: '1', transition: 'opacity 0.25s ease-in-out' } }>
            ...
            <div className="flex-viewport" style={ { overflow: 'hidden', position: 'relative' } }>
              <figure className="woocommerce-product-gallery__wrapper" style={ { width: '200%', transitionDuration: '0s', transform: 'translate3d(0px, 0px, 0px)' } }>
                <div data-thumb="http://demo.themes4wp.com/kakina/wp-content/uploads/sites/15/2015/09/bracelet-144646_1280-180x180.jpg" className="woocommerce-product-gallery__image flex-active-slide" style={ { width: '410px', marginRight: '0px', float: 'left', display: 'block', minHeight: '410px', position: 'relative', overflow: 'hidden' } }>
                  <a href="http://demo.themes4wp.com/kakina/wp-content/uploads/sites/15/2015/09/bracelet-144646_1280.jpg">
                    <img width="600" height="600" src="http://demo.themes4wp.com/kakina/wp-content/uploads/sites/15/2015/09/bracelet-144646_1280-600x600.jpg" className="attachment-shop_single size-shop_single wp-post-image" alt="" title="" data-src="http://demo.themes4wp.com/kakina/wp-content/uploads/sites/15/2015/09/bracelet-144646_1280.jpg" data-large_image="http://demo.themes4wp.com/kakina/wp-content/uploads/sites/15/2015/09/bracelet-144646_1280.jpg" data-large_image_width="1280" data-large_image_height="1097" srcSet="http://demo.themes4wp.com/kakina/wp-content/uploads/sites/15/2015/09/bracelet-144646_1280-600x600.jpg 600w, http://demo.themes4wp.com/kakina/wp-content/uploads/sites/15/2015/09/bracelet-144646_1280-150x150.jpg 150w, http://demo.themes4wp.com/kakina/wp-content/uploads/sites/15/2015/09/bracelet-144646_1280-300x300.jpg 300w, http://demo.themes4wp.com/kakina/wp-content/uploads/sites/15/2015/09/bracelet-144646_1280-60x60.jpg 60w, http://demo.themes4wp.com/kakina/wp-content/uploads/sites/15/2015/09/bracelet-144646_1280-180x180.jpg 180w" sizes="(max-width: 600px) 100vw, 600px" draggable="false" />
                  </a>
                  <img src="http://demo.themes4wp.com/kakina/wp-content/uploads/sites/15/2015/09/bracelet-144646_1280.jpg" className="zoomImg" style={ { position: 'absolute', top: '-214.659px', left: '-556.902px', opacity: '0', width: '1280px', height: '1097px', border: 'none', maxWidth: 'none', maxHeight: 'none' } } />
                </div>
              </figure>
            </div>
          ...
          <div className="summary entry-summary">
            <h1 className="product_title entry-title">Bracelet basic</h1>
            <p className="price">
              <del>
            ...
            <div className="woocommerce-product-details__short-description">
              <p> Maecenas ipsum velit, consectetuer eu lobortis ut, dictum at dui. Mauris tincidunt sem sed arcu. Duis sapien nunc, commodo et, interdum suscipit, sollicitudin et, dolor. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
            </div>
            ...
            <div className="yith-wcwl-add-to-wishlist add-to-wishlist-707">
              <div className="yith-wcwl-add-button show" style={ { display: 'block' } }>
                <a href="/kakina/product/bracelet-basic/?add_to_wishlist=707" rel="nofollow" data-product-id="707" data-product-type="simple" className="add_to_wishlist">Add to Wishlist</a>
              ...
              <div className="yith-wcwl-wishlistaddedbrowse hide" style={ { display: 'none' } }>
                ...
                <a href="http://demo.themes4wp.com/kakina/wishlist/" rel="nofollow">Browse Wishlist</a>
              </div>
            ...
            <div className="product_meta">
              <span className="posted_in">Category: 
                <a href="http://demo.themes4wp.com/kakina/product-category/jewelry/" rel="tag">Jewelry</a>
              </span>
            </div>
          </div>
          <div className="woocommerce-tabs wc-tabs-wrapper">
            ...
            <div className="woocommerce-Tabs-panel woocommerce-Tabs-panel--description panel entry-content wc-tab" id="tab-description" role="tabpanel" aria-labelledby="tab-title-description" style={ { display: 'block' } }>
              <h2>Description</h2>
              <p>Pellentesque ipsum. Nam sed tellus id magna elementum tincidunt. Nullam at arcu a est sollicitudin euismod. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Quisque porta. Duis condimentum augue id magna semper rutrum. Aliquam ante. Nunc dapibus tortor vel mi dapibus sollicitudin. Nullam lectus justo, vulputate eget mollis sed, tempor sed magna. Phasellus et lorem id felis nonummy placerat. Curabitur sagittis hendrerit ante. Etiam neque. Donec vitae arcu. In rutrum. Itaque earum rerum hic tenetur a sapiente delectus, ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis doloribus asperiores repellat. Vivamus ac leo pretium faucibus. Curabitur bibendum justo non orci. Etiam ligula pede, sagittis quis, interdum ultricies, scelerisque eu. Maecenas aliquet accumsan leo.</p>
              <p>Nulla accumsan, elit sit amet varius semper, nulla mauris mollis quam, tempor suscipit diam nulla vel leo. Nullam rhoncus aliquam metus. Duis risus. Fusce suscipit libero eget elit. Curabitur bibendum justo non orci. Aliquam id dolor. Fusce tellus odio, dapibus id fermentum quis, suscipit id erat. Aliquam in lorem sit amet leo accumsan lacinia. Maecenas ipsum velit, consectetuer eu lobortis ut, dictum at dui. Mauris tincidunt sem sed arcu. Duis sapien nunc, commodo et, interdum suscipit, sollicitudin et, dolor. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Mauris dictum facilisis augue. Nullam justo enim, consectetuer nec, ullamcorper ac, vestibulum in, elit. In convallis. Mauris suscipit, ligula sit amet pharetra semper, nibh ante cursus purus, vel sagittis velit mauris vel metus. Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur? Nulla turpis magna, cursus sit amet, suscipit a, interdum id, felis.</p>
            </div>
          ...
          <section className="related products">
            ...
            <ul className="products">
              <li className="post-700 product type-product status-publish has-post-thumbnail product_cat-jewelry product_cat-watches product_tag-gold product_tag-woman first instock shipping-taxable purchasable product-type-simple">
                ...
                <a rel="nofollow" href="/kakina/product/bracelet-basic/?add-to-cart=700" data-quantity="1" data-product_id="700" data-product_sku="" className="button product_type_simple add_to_cart_button ajax_add_to_cart">Add to cart</a>
